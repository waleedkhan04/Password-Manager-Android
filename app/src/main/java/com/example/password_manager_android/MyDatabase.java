...
public class MyDatabase {
    ...
    public ArrayList<PasswordClass> readAllNotes() {
        ...
        ArrayList<PasswordClass> allLogins = new ArrayList<>();
        ...
        {
            do{
                PasswordClass login = new PasswordClass();
    ...
    public ArrayList<PasswordClass> readAllDeletedNotes() {
        String loggedInUserID = getLoggedInID() + "";
